...
\unidade{}
\autores{Daniel Brai Gonzales Marcos \\ Nikoli dos Reis Nunes \\ Rodrigo Marinho \\ Kamilla Barbosa Silva \\ Larissa Aparecida Rovarotto dos Santos \\ Autor do trabalho 6 \\ Autor do trabalho 7 \\ Autor do trabalho 8}
...
\include{capitulos/01_empresa/root}
\include{capitulos/02_perfil_consumidor/root}
\include{capitulos/03_concorrencia/root}
\include{capitulos/04_composto_mercadologico/root}
\include{capitulos/05_estrutura_organizacional/root}
